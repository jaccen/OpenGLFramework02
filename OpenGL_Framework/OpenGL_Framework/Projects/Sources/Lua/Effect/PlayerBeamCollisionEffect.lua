...
function PlayerBeamCollisionEffectLogic(rCircleParticleSystem, rRingParticleSystem, rFrameCounter, rRandomGenerator, rPosition)
	...
	for i = 1, 5 do
		...
		particleCreateData.startWidth_ = 1.5
		particleCreateData.endWidth_ = rRandomGenerator:Random(1.5, 3.3)
		particleCreateData.startHeight_ = 0.22
		particleCreateData.endHeight_ = 0.13
		particleCreateData.startColor_ = S_Vector4(1.0, 0.8, 0.5, 0.1)
		particleCreateData.endColor_ = S_Vector4(0.5, 0.9, 0.2, 0.4)
		...
		particleCreateData.endWidth_ = particleCreateData.endWidth_ - 1.2
		particleCreateData.startHeight_ = 0.15
		particleCreateData.endHeight_ = 0.1
		particleCreateData.startColor_ = S_Vector4(0.3, 0.9, 0.1, 0.3)
		particleCreateData.endColor_ = S_Vector4(0.4, 0.9, 0.1, 0.7)
	...
	particleCreateData.startColor_ = S_Vector4(0.7, 0.8, 0.1, 0.3)
	particleCreateData.endColor_ = S_Vector4(0.7, 1.0, 0.0, 0.05)
