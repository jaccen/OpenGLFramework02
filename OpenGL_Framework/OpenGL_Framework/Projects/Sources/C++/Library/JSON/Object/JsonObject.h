...
#pragma region public静的メンバ関数
        ...
        /*************************************************************//**
         *
         *  @brief  文字列からJSONオブジェクトのポインタを作成する
         *  @param  文字列
         *  @return JSONオブジェクトのポインタ
         *
         ****************************************************************/
        static std::shared_ptr<JsonObject> s_CreatePointerFromString(const String& rFilePath)
        {
            auto pObject = std::make_shared<JsonObject>();
            *pObject = s_CreateFromString(rFilePath);
        ...
        /*************************************************************//**
         *
         *  @brief  ファイルからJSONオブジェクトのポインタを作成する
         *  @param  ファイルパス
         *  @return JSONオブジェクトのポインタ
         *
         ****************************************************************/
        static std::shared_ptr<JsonObject> s_CreatePointerFromFile(const String& rFilePath)
        {
            auto pObject = std::make_shared<JsonObject>();
            *pObject = s_CreateFromFile(rFilePath);
...
#pragma endregion
    ...
    /* 別名 */
    using JsonObjectPtr = std::shared_ptr<C_JsonObject<>>;                                  // JsonObjectPtr型
