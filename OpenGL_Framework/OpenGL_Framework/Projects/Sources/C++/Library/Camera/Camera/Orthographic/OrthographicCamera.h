...
namespace Camera
{
    ...
    public:
        ...
        virtual void SetNearClippingPlane(float nearClippingPlane = Matrix4::s_ORTHOGRAPHIC_2D_NEAR) override;          // ニアークリップ面を設定
        virtual void SetFarClippingPlane(float farClippingPlane = Matrix4::s_ORTHOGRAPHIC_2D_FAR) override;             // ファークリップ面を設定
    private:
        ...
        float nearClippingPlane_ = Matrix4::s_ORTHOGRAPHIC_2D_NEAR;                                                     ///< @brief ニアークリップ面
        float farClippingPlane_ = Matrix4::s_ORTHOGRAPHIC_2D_FAR;                                                       ///< @brief ファークリップ面
