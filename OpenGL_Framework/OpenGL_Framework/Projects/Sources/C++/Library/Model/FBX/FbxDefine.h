...
namespace Model
{
    ...
    namespace FBX
    {
        ...
        struct S_Bone
        {
            std::string nodeName_;                          ///< @brief ノード名
            std::string parentNodeName_;                    ///< @brief 親ノード名
            ...
            S_Bone(S_Bone&& rrOther) : 
                ...
                // ノード名
                nodeName_(std::move(rrOther.nodeName_)),

                // 親のノード名
                parentNodeName_(std::move(rrOther.parentNodeName_)),
