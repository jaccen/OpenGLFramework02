...
namespace Framework
{
    ...
    public:
        ...
        bool Run() override final;                                                                                                      // 実行処理
    protected:
        virtual bool Initialize();                                                                                                      // 初期化処理
        bool InitializeWithJsonFile(const std::string& rMainWindowDataFilePath = "Projects/LibraryDatas/JSON/MainWindowData.json",      // JSONファイルで初期化処理
