...
{
    /* 別名 */
    using ActiveFunction = float(*)(float);                                                 // ActiveFunction型
    using DerivativeFunction = float(*)(float);                                             // DerivativeFunction型
    ...
    //!
    //! @brief デリバティブファンクション
    //! @brief 活性化関数の導関数をまとめたユーティリティクラス
    //!
    //-------------------------------------------------------------
    class C_DerivativeFunction
    {
    public:
        static float s_Sigmoid(float x);                                                    // シグモイド導関数
    };
    ...
    struct S_Layer
    {
        ...
        DerivativeFunction pDerivativeFunction_ = C_DerivativeFunction::s_Sigmoid;          ///< @brief 活性化関数の導関数
