...
namespace ConnectWars
{
     ...
     *
     ****************************************************************/
    C_PlayerExplosionEffect::C_PlayerExplosionEffect(const std::string& rId, int32_t type) : C_BaseEffect(rId, type)
    {
     ...
     *
     ****************************************************************/
    C_PlayerExplosionEffect::~C_PlayerExplosionEffect()
    {
    }
     ...
     *
     ****************************************************************/
    void C_PlayerExplosionEffect::DoUpdate()
    {
        if (wpCircleParticleSystem_.expired() == false && wpSmokeParticleSystem_.expired() == false)
        {
            ...
            catch (luabind::error &rErrorInfo)
            {
                ...
                PrintLog("[ C_PlayerExplosionEffect::DoUpdate ] : 関数の呼び出しに失敗しました。\n");
                PrintLog("                エラーメッセージ : %s\n", stream.str().c_str());
     ...
     *
     ****************************************************************/
    void C_PlayerExplosionEffect::DoDraw()
    {
    }
     ...
     *
     ****************************************************************/
    bool C_PlayerExplosionEffect::DoMessageProcess(const Telegram& rTelegram)
    {
        return true;
    }
}