...
namespace ConnectWars
{
     ...
     *
     ****************************************************************/
    C_BackgroundMeteor::C_BackgroundMeteor(const std::string& rId, int32_t type) : C_BaseBackground(rId, type)
    {
        assert(OpenGL::C_PrimitiveBufferManager::s_GetInstance()->GetPrimitiveBuffer(ID::Primitive::s_pMETEOR));
        pModelData_ = OpenGL::C_PrimitiveBufferManager::s_GetInstance()->GetPrimitiveBuffer(ID::Primitive::s_pMETEOR).get();

        // テクスチャデータを取得
        assert(Texture::C_TextureManager::s_GetInstance()->GetTextureData(Path::Texture::s_pBACKGROND_METEOR));
        pTextureData_ = Texture::C_TextureManager::s_GetInstance()->GetTextureData(Path::Texture::s_pBACKGROND_METEOR).get();
     ...
     *
     ****************************************************************/
    C_BackgroundMeteor::~C_BackgroundMeteor()
    {
    }
     ...
     *
     ****************************************************************/
    void C_BackgroundMeteor::DoUpdate()
    {
    }
     ...
     *
     ****************************************************************/
    void C_BackgroundMeteor::DoDraw()
    {
     ...
     *
     ****************************************************************/
    bool C_BackgroundMeteor::DoMessageProcess(const Telegram& rTelegram)
    {
        return true;
    }
}