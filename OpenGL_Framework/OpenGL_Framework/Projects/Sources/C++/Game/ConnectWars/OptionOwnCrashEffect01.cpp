...
namespace ConnectWars
{
     ...
     *
     ****************************************************************/
    C_OptionOwnCrashEffect01::C_OptionOwnCrashEffect01(const std::string& rId, int32_t type) : C_BaseEffect(rId, type)
    {
     ...
     *
     ****************************************************************/
    C_OptionOwnCrashEffect01::~C_OptionOwnCrashEffect01()
    {
    }
     ...
     *
     ****************************************************************/
    void C_OptionOwnCrashEffect01::DoUpdate()
    {
        if (wpCircleParticleSystem_.expired() == false && wpSmokeParticleSystem_.expired() == false)
        {
            ...
            catch (luabind::error &rErrorInfo)
            {
                ...
                PrintLog("[ C_OptionOwnCrashEffect01::DoUpdate ] : 関数の呼び出しに失敗しました。\n");
                PrintLog("                エラーメッセージ : %s\n", stream.str().c_str());
     ...
     *
     ****************************************************************/
    void C_OptionOwnCrashEffect01::DoDraw()
    {
    }
     ...
     *
     ****************************************************************/
    bool C_OptionOwnCrashEffect01::DoMessageProcess(const Telegram& rTelegram)
    {
        return true;
    }
}