...
namespace ConnectWars
{
    ...
    //!
    //-------------------------------------------------------------
    class C_OptionSmallBeamCollisionEffect : public C_BaseEffect
    {
    public:
        C_OptionSmallBeamCollisionEffect(const std::string& rId, int32_t type);         // コンストラクタ
        virtual ~C_OptionSmallBeamCollisionEffect() override;                           // デストラクタ
    private:
