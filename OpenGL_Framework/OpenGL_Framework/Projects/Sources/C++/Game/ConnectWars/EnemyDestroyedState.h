...
namespace ConnectWars
{
    ...
    private:
        C_EnemyDestroyedState();                                                                        // コンストラクタ
        ~C_EnemyDestroyedState() override;                                                              // デストラクタ
    };
}