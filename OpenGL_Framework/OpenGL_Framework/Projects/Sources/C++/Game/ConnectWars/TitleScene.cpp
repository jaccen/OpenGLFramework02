...
=======
>>>>>>> parent of f268703... ã‚¹ãƒ—ãƒ©ã‚¤ãƒˆã‚¯ãƒªã‚¨ã‚¤ã‚¿ãƒ¼ãƒžãƒãƒ¼ã‚¸ãƒ£ãƒ¼ãƒ†ã‚¹ãƒˆå®Œäº†


//-------------------------------------------------------------
//!
//! @brief ƒRƒlƒNƒgƒEƒH[ƒY
//! @brief ƒRƒlƒNƒgƒEƒH[ƒYŠÖ˜A‚Ì–¼‘O‹óŠÔ
//!
//-------------------------------------------------------------
namespace ConnectWars
{
     ...
     *  @return ˆÙíI—¹FERROR_TERTINATION
     *
     ****************************************************************/
