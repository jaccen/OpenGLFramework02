...
layout (location = 4) in vec2 textureSize;				// テクスチャのサイズ
layout (location = 5) in vec2 textureUpperLeft;			// テクスチャの左上座標
layout (location = 6) in vec2 textureLowerRight;		// テクスチャの右下座標
